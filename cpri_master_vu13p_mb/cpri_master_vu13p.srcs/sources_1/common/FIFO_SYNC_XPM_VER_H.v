...
//File name       :  FIFO_SYNC_XPM_VER_H.v
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
module FIFO_SYNC_XPM_VER_H #(

    parameter integer FIFO_DEPTH   = 16,
    parameter integer DATA_WIDTH   = 32,
    parameter integer FULL_THRESH  = 16,    
    parameter integer EMPTY_THRESH = 6,
   ...
   xpm_fifo_sync #(
      ...
      .FIFO_MEMORY_TYPE("distributed"), //  "auto", "distributed", "block" or "ultra";
      ...
      .USE_ADV_FEATURES("1707"), // String,std=0707,fwft=1707
