...
//File name       :  Single_Port_ROM_XPM.v
//-----------------------------------------------------------------------------
...
module Single_Port_ROM_XPM #(
    ...
    output wire[RDATA_WIDTH-1:0]                             douta          
   ...
   xpm_memory_sprom #(
      .ADDR_WIDTH_A(WADDR_WIDTH),      // DECIMAL
      .AUTO_SLEEP_TIME(0),             // DECIMAL
      .CASCADE_HEIGHT(0),              // DECIMAL
      .ECC_MODE("no_ecc"),             // String
      .MEMORY_INIT_FILE("sin.coe"),    // String  "<filename>.mem" //xxxxx.coe                                                            
      .MEMORY_INIT_PARAM("0"),         // String
      .MEMORY_OPTIMIZATION("true"),    // String
      .MEMORY_PRIMITIVE("block"),      // String
      .MEMORY_SIZE(MEMORY_SIZE),       // DECIMAL
      .MESSAGE_CONTROL(0),             // DECIMAL
      .READ_DATA_WIDTH_A(RDATA_WIDTH), // DECIMAL
